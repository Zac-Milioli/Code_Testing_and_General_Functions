# Códigos usados na Calculadora de Balanço Térmico
# Desenvolvido no LabEEE
# https://github.com/labeee/Thermal-Balance-Calculator
...
def read_db_and_build_dicts(selected_zones, way):
    ...
    conn = sqlite3.connect(r'Python\SQLITE3 and Python\energyplus_test_scenario.sql')
...
if __name__ == '__main__':
    selected_zones = ['DORM1', 'SALA']
    way = 'convection'
    results = read_db_and_build_dicts(selected_zones, way)
    print(results)